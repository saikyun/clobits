...
(defn persist-lib
  [{:keys [ni-code wrapper-code java-code java-src-dir src-dir ni/wrapper-ns ni/generator-ns] :as opts}]
  
  (println "Persisting native image clj.")
  
  (letfn [(pathify [dir s ext] (str dir "/" (snake-case (str/replace (str s) "." "/")) ext))]
    (let [wrapper-path (pathify src-dir wrapper-ns ".clj")]
      (u/create-subdirs! wrapper-path)
      
      (with-open [wrtr (io/writer wrapper-path)]
    ...
    (let [generator-path (pathify src-dir generator-ns ".clj")]
      (u/create-subdirs! generator-path)
      
      (with-open [wrtr (io/writer generator-path)]
        (.write wrtr ";; This file is autogenerated -- probably shouldn't modify it by hand\n")
        (.write wrtr
    ...
    (doseq [{:keys [classname code]} java-code]
      (let [path (pathify java-src-dir classname ".java")]
